...
$nome = filter_input(INPUT_POST, "nome_usuario", FILTER_UNSAFE_RAW);
...
Versão usando $_POST (Menos segura)
...
<body>
    <form action="." method="POST">  <!-- action=".": Os dados são enviados para a mesma página -->
        <ul>
